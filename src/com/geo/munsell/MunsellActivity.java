...
public class MunsellActivity extends Activity implements OnSeekBarChangeListener  {
	public TextView txt_munsell;
	public TextView txt_descrizione;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        txt_munsell = (TextView) findViewById(R.id.textView1);
        txt_descrizione = (TextView) findViewById(R.id.descrizione);
        seek_bar = (SeekBar) findViewById(R.id.seekBar1);
        txt_descrizione.setText("");
        txt_munsell.setText("");
    ...
    public void onProgressChanged(SeekBar seek_bar, int progress,
    		boolean fromUser) {
    	Log.d("barra",Integer.toString(progress));
    	g.setSelection(progress);
    }
    
    public boolean onCreateOptionsMenu(Menu menu)
    {
		menu.add(1,1,0,"Grid View");
		menu.add(1,2,1,"Credits");
		return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
    	...
    	case 2:
        	...
        	conferma_canc.setMessage(Html.fromHtml("App developed by Luca Innocenti (lucainnoc@gmail.com).<a href=\"http://github.com/c1p81\">Source Code Link</a>. Reference: <a href=\"http://www.hq.nasa.gov/alsj/GeoRockClrChart.pdf\">Nasa</a>"));
...
//---------------------------------
    public class ImageAdapter extends BaseAdapter {
        ...
        public long getItemId(int position) {
        	...
        	txt_munsell.setText(colore);
        	txt_descrizione.setText(descrizione);
            return position;
        }
